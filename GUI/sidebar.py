...
class Sidebar(customtkinter.CTkFrame):
    def __init__(self, master):
        ...
        self.home_button = customtkinter.CTkButton(self, command=lambda: [mass_update_information(app._view.day_view, selected_date), app.switch_view(MainPage)] if ".!dayviewpage" in str(app._view) else app.switch_view(MainPage), hover_color="black",
        ...
        self.terminal_button = customtkinter.CTkButton(self, command=lambda: [mass_update_information(app._view.day_view, selected_date), app.switch_view(TerminalPageFrame)] if ".!dayviewpage" in str(app._view) else app.switch_view(TerminalPageFrame), hover_color="black",
        ...
        self.calendar_button = customtkinter.CTkButton(self, command=lambda: [mass_update_information(app._view.day_view, selected_date), app.switch_view(CalendarPage)] if ".!dayviewpage" in str(app._view) else app.switch_view(CalendarPage), hover_color="black",
        ...
        self.settings_button = customtkinter.CTkButton(self, command=lambda: [mass_update_information(app._view.day_view, selected_date), app.switch_view(SettingsPageFrame)] if ".!dayviewpage" in str(app._view) else app.switch_view(SettingsPageFrame), hover_color="black",
